...
### Setup
-To clone the repository run `https://github.com/NATASHA-ct/Admissions-trials.git` in your terminal
...
- Apreciation to Nimrod Acosta github>(nimplay) for his code
